...
#define LFio TRISDbits.RD2      //Left motor Foward direction IO
#define LBio TRISDbits.RD3      //Left motor Backward direction IO
#define RFio TRISDbits.RD1      //Right motor Foward direction IO
#define RBio TRISDbits.RD0      //Right motor backward direction IO
#define LEN LATCbits.LC2        //Left motor Enable (CCP1)
#define REN LATCbits.LC1        //Right motor Enable (CCP2)
#define LF LATDbits.LD2         //Left motor Foward direction
#define LB LATDbits.LD3         //Left motor Backward direction
#define RF LATDbits.LD1         //Right motor Foward direction
#define RB LATDbits.LD0         //Right motor backward direction
